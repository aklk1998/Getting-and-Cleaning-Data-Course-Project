...
##
## Write the 2 output tables to 2 csv files:
##   (1) combined_train_test_data to combined_train_test_data.csv
##   (2) by_activity_subject_mean to by_activity_subject_mean.csv
##
...
## Write csv files
##
write.csv(combined_train_test_data,file="C:\\Data Files\\Coursea\\Getting_and_Cleaning_Data\\combined_train_test_data.csv",row.names=FALSE)
write.csv(by_activity_subject_mean,file="C:\\Data Files\\Coursea\\Getting_and_Cleaning_Data\\by_activity_subject_mean.csv",row.names=FALSE)
