...
## (6) Write the 2 output tables to 2 txt files without row names
##     (6.1) combined_train_test_data to combined_train_test_data.txt
##     (6.2) by_activity_subject_mean to by_activity_subject_mean.txt
##
## Output Table Names:
##
...
##
##   (1) combined_train_test_data.txt
##   (2) by_activity_subject_mean to by_activity_subject_mean.txt
##
...
##
## Write the 2 output tables to 2 txt files:
##   (1) combined_train_test_data to combined_train_test_data.txt
##   (2) by_activity_subject_mean to by_activity_subject_mean.txt
##
...
## Write txt files
##
write.table(combined_train_test_data,file="C:\\Data Files\\Coursea\\Getting_and_Cleaning_Data\\combined_train_test_data.txt",row.names=FALSE)
